              ...
              return (
                <article key={item.q} className="overflow-hidden rounded-[1.5rem] border border-sahm-purple/10 bg-slate-50">
                  <button
                    ...
                    className="flex w-full cursor-pointer items-center justify-between gap-4 px-5 py-4 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-sahm-purple"
